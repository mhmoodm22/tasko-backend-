...
import com.taskmanager.ws.SpringApplicationContext;
import com.taskmanager.ws.service.UserService;
import com.taskmanager.ws.shared.dto.UserDto;
import com.taskmanager.ws.ui.model.request.UserLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String bearertoken = SecurityConstants.TOKEN_PREFIX + token;
         ...
         Cookie cookie = new Cookie(SecurityConstants.HEADER_STRING,token );
